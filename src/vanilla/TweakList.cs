...
namespace AutoRest.Ansible
{
    public class Tweaks
    {
        public static Tweak[] All =
        {
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "gateway_ip_configurations.subnet.id", "/subscriptions/{{ azure_subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/virtualNetworks/sample-vnet/subnets/sample-subnet"),
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "frontend_ip_configurations.subnet.id", "/subscriptions/{{ azure_subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/virtualNetworks/sample-vnet/subnets/sample-subnet"),
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "request_routing_rules.http_listener.id", "/subscriptions/{{ azure_subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/applicationGateways/appgateway{{ random_postfix }}{{ resource_group | hash('md5') | truncate(7, True, '') }}/httpListeners/sample_http_listener"),
