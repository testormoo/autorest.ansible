...
namespace AutoRest.Ansible
{
    public class Tweaks
    {
        public static Tweak[] All =
        {
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "gateway_ip_configurations.subnet.id", "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/virtualNetworks/sample-vnet/subnets/sample-subnet"),
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "frontend_ip_configurations.subnet.id", "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/virtualNetworks/sample-vnet/subnets/sample-subnet"),
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "http_listeners.frontend_ip_configuration.id", "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/applicationGateways/appgateway{{ random_postfix }}{{ resource_group | hash('md5') | truncate(7, True, '') }}/frontendIPConfigurations/sample_gateway_frontend_ip_config"),
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "http_listeners.frontend_port.id", "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/applicationGateways/appgateway{{ random_postfix }}{{ resource_group | hash('md5') | truncate(7, True, '') }}/frontendPorts/ag_frontend_port"),
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "request_routing_rules.http_listener.id", "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/applicationGateways/appgateway{{ random_postfix }}{{ resource_group | hash('md5') | truncate(7, True, '') }}/httpListeners/sample_http_listener"),
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "request_routing_rules.backend_address_pool.id", "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/applicationGateways/appgateway{{ random_postfix }}{{ resource_group | hash('md5') | truncate(7, True, '') }}/backendAddressPools/test_backend_address_pool"),
            new Tweak_Option_DefaultValueTest("azure_rm_applicationgatewayapplicationgateway", "request_routing_rules.backend_http_settings.id", "/subscriptions/{{ subscription_id }}/resourceGroups/{{ resource_group }}/providers/Microsoft.Network/applicationGateways/appgateway{{ random_postfix }}{{ resource_group | hash('md5') | truncate(7, True, '') }}/backendHttpSettingsCollection/sample_appgateway_http_settings"),
