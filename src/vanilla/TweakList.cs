...
namespace AutoRest.Ansible
{
    public class Tweaks
    {
        public static Tweak[] All =
        {
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_sql_elasticpools", "resource_group_name", "\"{{ resource_group }}\""),
            ...
            new Tweak_Option_DefaultValueTest("azure_rm_mysql_servers", "resource_group_name", "\"{{ resource_group }}\""),
