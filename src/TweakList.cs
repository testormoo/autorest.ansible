...
namespace AutoRest.Ansible
{
    public class Tweaks
    {
        public static Tweak[] All =
        {
            ...
            new Tweak_Option_Exclude("azure_rm_sqldatabase", "parameters.requested_service_objective_id", true, false),
            new Tweak_Option_Exclude("azure_rm_sqldatabase", "parameters.requested_service_objective_name", true, false),
